...
--------------------------------------------------------
  ...
  CREATE TABLE "EPI_PARAM" 
   ...
   COMMENT ON COLUMN "EPI_PARAM"."CRD" IS 'Rekord Létrehozásának időpecsétje';
 
   COMMENT ON COLUMN "EPI_PARAM"."MDU" IS 'Rekord Módosítójának Azonosítója';
 
   COMMENT ON COLUMN "EPI_PARAM"."MDD" IS 'Rekord Módosításának Időpecsétje';
 
   COMMENT ON COLUMN "EPI_PARAM"."W_PARAM_TYPE" IS 'Az PARAM_TYPE_ID megnevezése ellenőrzéshez és feltöltéshez';
