...
--------------------------------------------------------
  ...
  CREATE TABLE "WK_TREATM_REL" 
   ...
   COMMENT ON COLUMN "WK_TREATM_REL"."REL_TYPE_ID" IS 'Műveletterv relációk (norma-terv, tervvariáció, terv-kezelés)';
   ...
   COMMENT ON COLUMN "WK_TREATM_REL"."TIME_START" IS 'Kezelés (tervezett, tényleges) kezdő időpontja (dátum, óra,perc)';
 
   COMMENT ON COLUMN "WK_TREATM_REL"."TIME_END" IS 'Kezelés (tervezett, tényleges) záró időpontja (dátum, óra,perc)';
   ...
   COMMENT ON COLUMN "WK_TREATM_REL"."CRD" IS 'Rekord Létrehozásának időpecsétje';
 
   COMMENT ON COLUMN "WK_TREATM_REL"."MDU" IS 'Rekord Módosítójának Azonosítója';
 
   COMMENT ON COLUMN "WK_TREATM_REL"."MDD" IS 'Rekord Módosításának Időpecsétje';
