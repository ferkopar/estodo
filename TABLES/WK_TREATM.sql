...
--------------------------------------------------------
  ...
  CREATE TABLE "WK_TREATM" 
   ...
   COMMENT ON COLUMN "WK_TREATM"."TREATM_TYPE_ID" IS 'Művelet típusa';
 
   COMMENT ON COLUMN "WK_TREATM"."STATUS_ID" IS 'Az adat státuszának, feldolgozottságának egyedi azonosítója';
 
   COMMENT ON COLUMN "WK_TREATM"."TREATM_CATEGORY_ID" IS 'A művelet,	anatómiai testrész besorolásának egyedi azonosítója';
 
   COMMENT ON COLUMN "WK_TREATM"."MM_ID" IS 'Kapcsolódó dokumentum egyedi azonosítója';
 
   COMMENT ON COLUMN "WK_TREATM"."TIME_START" IS 'A művelet, kezelés (tervezett, tényleges) kezdő időpontja (dátum, óra, perc)';
 
   COMMENT ON COLUMN "WK_TREATM"."TIME_END" IS 'A művelet,	kezelés (tervezett, tényleges) záró időpontja (dátum, óra, perc)';
   ...
   COMMENT ON COLUMN "WK_TREATM"."CRD" IS 'Rekord Létrehozásának időpecsétje';
 
   COMMENT ON COLUMN "WK_TREATM"."MDD" IS 'Rekord Módosításának Időpecsétje';
