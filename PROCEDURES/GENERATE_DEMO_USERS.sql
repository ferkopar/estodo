...
BEGIN
   ...
   v_beoarray := beoArray('Projekt vezető','Csoport vezető','Térinformatikai ov','Térinformatikus','Adatbázis tervező','Rendszer architektúra tervező','Minőségbiztosító','Hálózat fejlesztő','Hálózat tervező','Rendszertervező','Informatikai biztonsági auditor');
   v_feladarray := feladArray('Adózási rendszer','Pénzügyi rendszer','E-építésügy','MEPÁR fejlesztés','Termelésirányítási rendszer adatbázisának tervezése'
    ,'A-rendszer minőség ellenőrzése, átvétele','Hálózat bővítés','X hálózati infrastruktúra átalakítása','Y rendszertervezése'
    ,'Z rendszer biztonsági auditja','');
   v_csoparray := csopArray('5 rendszerszervező, programozó','3 Informatikus','6 térinformatikus','','','','','','','','');
