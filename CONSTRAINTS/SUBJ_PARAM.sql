...
--------------------------------------------------------
  ...
  ALTER TABLE "SUBJ_PARAM" MODIFY ("SUBJ_ID" NOT NULL ENABLE);
 
  ALTER TABLE "SUBJ_PARAM" MODIFY ("CRU" NOT NULL ENABLE);
 
  ALTER TABLE "SUBJ_PARAM" MODIFY ("CRD" NOT NULL ENABLE);
 
  ALTER TABLE "SUBJ_PARAM" MODIFY ("PARAM_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "SUBJ_PARAM" MODIFY ("ORDER_NO" NOT NULL ENABLE);
