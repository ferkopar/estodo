...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "VD_TREATM" ("TREATM_ID", "TREATM_NAME", "TREATM_GROUP_ID", "TREATM_GROUP_NAME", "TREATM_TYPE_ID", "TREATM_TYPE_NAME", "TREATM_CATEGORY_ID", "TREATM_CATEGORY_NAME", "MM_ID", "TIME_START", "TIME_END", "SUBJ1_ID", "SUBJ1_NAME", "TYPE1_ID", "TYPE1_NAME", "SUBJ2_ID", "SUBJ2_NAME", "TYPE2_ID", "TYPE2_NAME", "DESCRIPTION", "CRU", "CRD", "MDD", "MDU", "FROM_DATE", "TO_DATE", "TREATM_NAME_ID") AS 
  SELECT t.TREATM_ID,
           t.TREATM_NAME,
           t.TREATM_GROUP_ID,
