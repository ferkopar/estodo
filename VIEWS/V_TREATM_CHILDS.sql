...
--------------------------------------------------------
 ...
 --      '<a href= "javascript:callMyPopup('||TREATM.TREATM_ID || ')"><img src="'||V('WORKSPACE_IMAGES')||'File_Edit.png"></a>' AS LINK,
       ...
       TREATM.TREATM_TYPE_ID as TREATM_CATEGORY_ID,
       lookup_super_type_name(TREATM.TREATM_TYPE_ID) AS TREATM_CATEGORY_NAME,
       0 as TYPE1_ID,
       lookup_super_type_name(0) AS TYPE1_NAME,
       0 as TYPE2_ID,
       lookup_super_type_name(0) AS TYPE2_NAME,
