...
insert INTO SUBJECT 
            (ROLL_TYPE,SUBJ_TYPE_ID)
       VALUES (0,v_subj_type_id)
       RETURNING subj_id INTO v_subj_id;

-- Vezetéknév
insert INTO subj_param 
            (SUBJ_ID,PARAM_TYPE_ID,VALUE)
       VALUES
            (v_subj_id,1112,p_last_name);
-- Keresztnév
insert INTO subj_param 
            (SUBJ_ID,PARAM_TYPE_ID,VALUE)
       VALUES
            (v_subj_id,1113,p_first_name);
-- Emilcím
insert INTO subj_param 
            (SUBJ_ID,PARAM_TYPE_ID,VALUE)
       VALUES
            (v_subj_id,1121,p_email);

-- Telefon
insert INTO subj_param 
            (SUBJ_ID,PARAM_TYPE_ID,VALUE)
       VALUES
            (v_subj_id,1125,p_phone);

-- subj típus felhasználó
insert INTO subj_param 
            (SUBJ_ID,PARAM_TYPE_ID,VALUE,VALUE_TYPE_ID)
       VALUES
            (v_subj_id,1001,'1011', v_subj_type_id);
