...
-- get_subject_name
  ...
  BEGIN
    ...
    -- return GET_CATEGORY(p_subj_id);
    IF GET_CATEGORY(p_subj_id) in (102,103,121) THEN
    ...
    ELSE
      ...
      EXCEPTION
      WHEN OTHERS THEN
             v_retval := v_retval || ' személyek ' || GET_CATEGORY(p_subj_id) ;
      END;
    END IF;
    RETURN v_retval;
