...
begin
  for szallito in szallitok loop
     ...
     insert INTO SUBJ_PARAM (SUBJ_ID,PARAM_TYPE_ID,VALUE,SUBJ_TYPE_ID,GROUP_ID) values(v_subj_id,11901,szallito."Számlavezető bank neve",5000001238,v_group_id);
...
begin
  for vevo in vevok loop
     ...
     insert INTO SUBJ_PARAM (SUBJ_ID,PARAM_TYPE_ID,VALUE,SUBJ_TYPE_ID,GROUP_ID) values(v_subj_id,11901,vevo."Számlavezető bank neve",5000001238,v_group_id);
  ...
  BEGIN
    FOR worker in workers loop
      ...
      insert INTO SUBJ_PARAM (SUBJ_ID,PARAM_TYPE_ID,VALUE,SUBJ_TYPE_ID) values(v_subj_id,11100,'',111) 
        ...
        insert INTO SUBJ_PARAM (SUBJ_ID,PARAM_TYPE_ID,VALUE,SUBJ_TYPE_ID,GROUP_ID) 
          values(v_subj_id,11108,to_char(worker."születetési idő",'YYYY.MM.DD'),111,v_group_id);
        insert INTO SUBJ_PARAM (SUBJ_ID,PARAM_TYPE_ID,VALUE,SUBJ_TYPE_ID,GROUP_ID) 
...
--      v_id_tmp:= get_street_id(worker.UTCA_NÉV);      
      ...
      insert INTO SUBJ_PARAM (SUBJ_ID,PARAM_TYPE_ID,VALUE,SUBJ_TYPE_ID,GROUP_ID) 
          values(v_subj_id,5000335918,worker."vezetői engedély száma",111,v_group_id);
      insert INTO SUBJ_PARAM (SUBJ_ID,PARAM_TYPE_ID,VALUE,SUBJ_TYPE_ID,GROUP_ID) 
